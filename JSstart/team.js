...
// чи має право керувати атомобілем водій з певним іменем (взяти імя водія і порізвняти з усіма іменами водіїв
//       які мають право керувати автомобілем, якщо співпало, то може, якщо не співпало то не може)
